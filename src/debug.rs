...
pub fn dump_run_context(run_context: &WHV_RUN_VP_EXIT_CONTEXT) {
    ...
    let execution_state = run_context.VpContext.ExecutionState;

    println!("Execution state: ");
    println!("Cpl: {}", execution_state.Cpl());
    println!("Cr0Pe: {}", execution_state.Cr0Pe());
    println!("Cr0Am: {}", execution_state.Cr0Am());
    println!("EferLma: {}", execution_state.EferLma());
    println!("DebugActive: {}", execution_state.DebugActive());
    println!("InterruptionPending: {}", execution_state.InterruptionPending());
    println!("Reserved0: {}", execution_state.Reserved0());
    println!("InterruptShadow: {}", execution_state.InterruptShadow());
    println!("Reserved1: {}", execution_state.Reserved1());
}
